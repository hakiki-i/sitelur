...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Tambah Agen</h2>
            <p class="text-sm text-gray-400 mt-0.5">Masukkan data agen baru</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-blue-50 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-50 flex items-center gap-2">
            ...
            <span class="font-semibold text-gray-700">Form Tambah Agen</span>
        </div>
        <div class="p-6">
            <form action="{{ route('agen.store') }}" method="POST" class="space-y-5">
                @csrf
                <div>
                    <label for="nama_agen" class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1.5">Nama Agen</label>
                    <input type="text" name="nama_agen" id="nama_agen" required
