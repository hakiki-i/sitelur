...
@section('title', 'Tambah Harga Telur')
...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Tambah Harga Telur</h2>
            <p class="text-sm text-gray-400 mt-0.5">Input harga telur baru</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-blue-50 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-50 flex items-center gap-2">
            ...
            <span class="font-semibold text-gray-700">Form Harga Telur</span>
        </div>
        <div class="p-6">
            <form action="{{ route('harga_telur.store') }}" method="POST" class="space-y-5">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <input type="number" name="harga_layak" id="harga_layak" value="{{ old('harga_layak') }}" required
                        class="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent focus:bg-white transition-all duration-200">
                ...
                <div>
                    ...
                    <input type="number" name="harga_tidak_layak" id="harga_tidak_layak" value="{{ old('harga_tidak_layak') }}" required
                        class="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent focus:bg-white transition-all duration-200">
